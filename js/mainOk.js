...
for(var i = 0; i<array.length;i++){
  ...
  function nuovascena(id){
    ...
    const sprite1 = texture2Loader.load( 'assets/textures/snowflake1.png' );
    const sprite2 = texture2Loader.load( 'assets/textures/snowflake2.png' );
    const sprite3 = texture2Loader.load( 'assets/textures/snowflake3.png' );
    const sprite4 = texture2Loader.load( 'assets/textures/snowflake4.png' );
    const sprite5 = texture2Loader.load( 'assets/textures/snowflake5.png' );
...
/*
  ...
  */
      ...
      */
      ...
      const ballTexture = new THREE.TextureLoader().load("assets/textures/worldColour.5400x2700.jpg");
      ballMat.map = ballTexture;
      const displacementMapBall = new THREE.TextureLoader().load("assets/textures/earthOk.jpg");
      ballMat.displacementMapBall = displacementMapBall;
      ballMat.displacementScale = .1;

      const floorMat = new THREE.MeshPhongMaterial();
      const floorTexture = new THREE.TextureLoader().load("assets/textures/rollingHillsBitMap.png");
      floorMat.map = floorTexture;
      const displacementMap = new THREE.TextureLoader().load("assets/textures/HeightMap.png");
      floorMat.displacementMap = displacementMap;
      floorMat.displacementScale = 2;

      const cubeMat = new THREE.MeshPhongMaterial();
      
      const cubeTexture = new THREE.TextureLoader().load("assets/textures/steel.jpg");
      cubeMat.map = cubeTexture;
      const displacementMapCube = new THREE.TextureLoader().load("assets/textures/HeightMap.jpg");
